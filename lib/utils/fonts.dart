...
TextStyle sfProText25 = GoogleFonts.sourceSansPro(
    fontSize: 25, fontWeight: FontWeight.w700, color: number);

TextStyle sfProText10 = GoogleFonts.sourceSansPro(
    fontSize: 10, fontWeight: FontWeight.w700, color: number);

TextStyle sfProText15 = GoogleFonts.sourceSansPro(
    fontSize: 15, fontWeight: FontWeight.w700, color: settingsColor);
